...
function init(){
	...
	$('#pafRing2Img').transition({perspective:480, rotateY:"-45", rotateZ:"125"}, 1, 'linear');
	$('#pafRing3Img').transition({perspective:480, rotateX:"57", rotateZ:"120"}, 1, 'linear');
	$('#pafRing4Img').transition({perspective:480, rotateX:"75", rotateY:"310", rotateZ:"185"}, 1, 'linear');
